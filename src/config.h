...
/* OTA */
#define DEFAULT_UPDATE_SERVER "https://iot.okosengineering.com"
#define OTA_CHECK_DEVICE_URI "/ota/device/"      // OTA update check endpoint for device
#define OTA_CHECK_GROUP_URI "/ota/device_group/"        // OTA update check endpoint for group
#define OTA_DOWNLOAD_DEVICE_URI "/ota/device/download/" // OTA update download endpoint for device
#define OTA_DOWNLOAD_GROUP_URI "/ota/device_group/download/"   // OTA update download endpoint for group
